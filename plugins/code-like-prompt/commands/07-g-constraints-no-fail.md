---
description: Prolog-style backtracking - Graph coloring with constraint propagation (first solution only)
argument-hint: ""
---
...
?- coloring(A, B, C), write(A), write('-'), write(B), write('-'), write(C), nl.
```
